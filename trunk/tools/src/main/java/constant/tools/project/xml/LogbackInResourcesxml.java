...
public class LogbackInResourcesxml {
    ...
    public static String generate(String name) {
        ...
        stringBuffer.append(
                " <property name=\"" + n + "_loggingRoot\" value=\"${catalina.home}/logs/lechinepay.qrpay.boss\" />\n");
        stringBuffer.append(" <property name=\"" + n + "_loggingLevel\" value=\"INFO\" />\n");
        ...
        stringBuffer.append(
                "   <fileNamePattern>${" + n + "_loggingRoot}/dao.debug.log.%d{yyyy-MM-dd}-%i.zip</fileNamePattern>\n");
        ...
        stringBuffer.append("  <rollingPolicy class=\"ch.qos.logback.core.rolling.TimeBasedRollingPolicy\">\n");
        stringBuffer.append(
                "   <fileNamePattern>${" + n + "_loggingRoot}/debug.log.%d{yyyy-MM-dd}-%i.zip</fileNamePattern>\n");
        stringBuffer.append("   <maxHistory>30</maxHistory>\n");
        stringBuffer.append(
                "   <timeBasedFileNamingAndTriggeringPolicy class=\"ch.qos.logback.core.rolling.SizeAndTimeBasedFNATP\">\n");
        stringBuffer.append("    <maxFileSize>60MB</maxFileSize>\n");
        ...
        stringBuffer.append("  <rollingPolicy class=\"ch.qos.logback.core.rolling.TimeBasedRollingPolicy\">\n");
        stringBuffer.append(
                "   <fileNamePattern>${" + n + "_loggingRoot}/info.log.%d{yyyy-MM-dd}-%i.zip</fileNamePattern>\n");
        stringBuffer.append("   <maxHistory>30</maxHistory>\n");
        stringBuffer.append(
                "   <timeBasedFileNamingAndTriggeringPolicy class=\"ch.qos.logback.core.rolling.SizeAndTimeBasedFNATP\">\n");
        ...
        stringBuffer.append("  <rollingPolicy class=\"ch.qos.logback.core.rolling.TimeBasedRollingPolicy\">\n");
        stringBuffer.append(
                "   <fileNamePattern>${" + n + "_loggingRoot}/warn.log.%d{yyyy-MM-dd}-%i.zip</fileNamePattern>\n");
        stringBuffer.append("   <maxHistory>30</maxHistory>\n");
        stringBuffer.append(
                "   <timeBasedFileNamingAndTriggeringPolicy class=\"ch.qos.logback.core.rolling.SizeAndTimeBasedFNATP\">\n");
        ...
        stringBuffer.append("  <rollingPolicy class=\"ch.qos.logback.core.rolling.TimeBasedRollingPolicy\">\n");
        stringBuffer.append(
                "   <fileNamePattern>${" + n + "_loggingRoot}/error.log.%d{yyyy-MM-dd}-%i.zip</fileNamePattern>\n");
        stringBuffer.append("   <maxHistory>30</maxHistory>\n");
        stringBuffer.append(
                "   <timeBasedFileNamingAndTriggeringPolicy class=\"ch.qos.logback.core.rolling.SizeAndTimeBasedFNATP\">\n");
